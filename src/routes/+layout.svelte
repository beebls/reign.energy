...
<div class="bg-black w-screen min-h-screen flex flex-col">
	<slot />
</div>
<svelte:head>
	<!-- Primary Meta Tags -->
	<title>i love reign energy</title>
	<meta name="title" content="i love reign energy" />
	<meta name="description" content="regin energ" />
